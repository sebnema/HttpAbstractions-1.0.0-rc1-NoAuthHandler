...
namespace TBMMNet.Web.Core.Identity
{
    ...
    {
        public IdentityUserStore(IdentityUserContext context, IdentityErrorDescriber describer = null) : base(context, describer) { }
    }
    ...
    public class IdentityUserStore<TUser> : IdentityUserStore<TUser, IdentityRole, IdentityUserContext>
    ...
    public class IdentityUserStore<TUser, TRole, TContext> : IdentityUserStore<TUser, TRole, TContext, string>
        ...
        where TContext : IdentityUserContext
    {
    ...
    public class IdentityUserStore<TUser, TRole, TContext, TKey> :
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        public IdentityUserStore(TContext context, IdentityErrorDescriber describer = null)
        {
            if (context == null)
            {
        ...
        public async virtual Task<IdentityResult> CreateAsync(TUser user, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            user = await Context.CreateNewUser<TUser,TKey>(user);
        ...
        public virtual Task<TUser> FindByIdAsync(string userId, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return Context.FindByIdAsync<TUser,TKey>(userId);
        }
        ...
        public virtual Task<TUser> FindByNameAsync(string normalizedUserName, CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
            return Context.FindByNameAsync<TUser,TKey>(normalizedUserName);
        }
        ...
        public virtual Task SetPasswordHashAsync(TUser user, string passwordHash, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            //Context.SaveUser<TUser,TKey>(user);
            return Task.FromResult(0);
        }
        ...
        public virtual async Task<IList<string>> GetRolesAsync(TUser user, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return await Context.GetUserRoles<TUser,TKey>(userId);
        ...
        public virtual async Task<bool> IsInRoleAsync(TUser user, string roleName, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return await Context.IsInRoleAsync<TUser,TKey>(user, roleName);
        ...
        private IList<TRole> Roles = new List<TRole>();
        private IList<IdentityUserClaim<TKey>> UserClaims = new List<IdentityUserClaim<TKey>>();
        private IList<IdentityUserRole<TKey>> UserRoles { get; set; } = new List<IdentityUserRole<TKey>>();
        private IList<IdentityUserLogin<TKey>> UserLogins = new List<IdentityUserLogin<TKey>>();

        //private IList<TRole> Roles { get { return Context.GetRoles<TRole>(); } }
        //private IList<IdentityUserClaim<TKey>> UserClaims { get { return Context.GetUserClaims<TKey>(); } }
        //private IList<IdentityUserRole<TKey>> UserRoles { get { return Context.GetUserRoles<TKey>(); } }
        //private IList<IdentityUserLogin<TKey>> UserLogins { get { return Context.GetUserLogins<TKey>(); } }
        ...
        public async virtual Task<IList<Claim>> GetClaimsAsync(TUser user, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var list = await Context.GetClaimsAsync(user.Id);
        ...
        public virtual Task AddClaimsAsync(TUser user, IEnumerable<Claim> claims, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            //Context.SaveUserClaims(UserClaims); ;
        ...
        public async virtual Task ReplaceClaimAsync(TUser user, Claim claim, Claim newClaim, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var matchedClaims = await Context.GetClaimsAsync(user.Id, claim.Value, claim.Type);
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            //var result = Context.AddUserLogin(l);
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var userId = user.Id;
            var entry = await Context.GetUserLoginAsync(userId, loginProvider, providerKey);
            if (entry != null)
            {
        ...
        public async virtual Task<IList<UserLoginInfo>> GetLoginsAsync(TUser user, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var userId = user.Id;
            var list = await Context.GetUserLoginsAsync(userId);
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
            var userLogin = await Context.GetUserLoginAsync<TKey>(loginProvider, providerKey);

            if (userLogin != null)
            {
                return await Context.FindByIdAsync<TUser, TKey>(userLogin.UserId);
            }
            return null;
        }
        ...
        public virtual Task<TUser> FindByEmailAsync(string normalizedEmail, CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
            return Context.FindByEmailAsync<TUser,TKey>(normalizedEmail);
        }
        ...
        public async virtual Task<IList<TUser>> GetUsersForClaimAsync(Claim claim, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return await Context.GetUsersForClaimAsync<TUser>(claim.Value, claim.Type);
        }
        ...
        public async virtual Task<IList<TUser>> GetUsersInRoleAsync(string roleName, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return await Context.GetUsersInRoleAsync<TUser>(roleName);
        }
    }
